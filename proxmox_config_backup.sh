...
######################
## Install: copy file over (and adjust path) and add cron job
# 1) copy over file
# cp /home/moon/pubdotfiles/proxmox_config_backup.sh /home/moon/proxmox_config_backup.sh
# 2) cron job (adjust minute individually):
# 17 5 * * * /home/moon/proxmox_config_backup.sh >> /home/moon/logs/sudologs.txt 2>&1
######################
...
_bdir=${BACK_DIR:-/mnt/backup-server/proxmox}
...
# commented out description -> no need to push enter anymore
# description
